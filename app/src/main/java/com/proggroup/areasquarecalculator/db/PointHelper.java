...
public class PointHelper {
	...
	public static final String CREATE_REQUEST = "create table " + TABLE_NAME +
			" ( " + BaseColumns._ID + " integer primary key autoincrement, " + POINT_X + " real " +
			"not null, " + POINT_Y + " real not null, " + SquarePointHelper.ID + " integer not " +
			"null);";
	...
	public void deletePoints(long squarePointId) {
		writeDb.delete(TABLE_NAME, SquarePointHelper.ID + " = ?", new String[]{"" +
				squarePointId});
	}
