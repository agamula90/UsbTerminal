...
public class ProjectHelper {
	...
	public static final String CREATE_REQUEST = "create table " + Project.TABLE_NAME +
			" ( " + BaseColumns._ID + " integer primary key autoincrement, " + Project
			.IS_SIMPLE_MEASURE + " integer not null);";
	...
	public List<Project> getProjects() {
		Cursor cursor = writeDb.query(Project.TABLE_NAME, new String[]{BaseColumns._ID, Project
