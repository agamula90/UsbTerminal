...
public final class Toaster {
	 ...
	 * @param resId    the id of the string to display
	 * @param error    is the message an error (changes the text to red)
	 */
	@Deprecated
	public static void showToastOnMainThread(final Activity activity, final int resId, final
	boolean error) {
	 ...
	 */
	@Deprecated
	public static void showToastOnMainThread(final Activity activity, final CharSequence message,
			final boolean error) {
		activity.runOnUiThread(new Runnable() {
	 ...
	 */
	@Deprecated
	public static void showToast(final Context ctx, final CharSequence message, final boolean
			error) {
		Toast toast;
		TextView view;
