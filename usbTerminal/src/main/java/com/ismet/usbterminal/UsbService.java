...
public class UsbService extends Service {
	...
	public static final String ACTION_CDC_DRIVER_NOT_WORKING = "com.ismet.connectivityservices" +
			".ACTION_CDC_DRIVER_NOT_WORKING";

	public static final String ACTION_USB_DEVICE_NOT_WORKING = "com.ismet.connectivityservices" +
	...
	private UsbSerialInterface.UsbReadCallback mCallback = new UsbSerialInterface.UsbReadCallback
		...
		public void onReceivedData(byte[] arr) {
			try {
				...
				//				if(mHandler != null)
				//					mHandler.obtainMessage(MESSAGE_FROM_SERIAL_PORT,data)
				// .sendToTarget();
	...
	private final BroadcastReceiver usbReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context arg0, Intent arg1) {
			...
			//					//findSerialPortDevice(); // A USB device has been attached. Try
			// to open it as
			// a Serial port
			//				}
