...
class LocalPowerCommandsFactory(
    ...
    private val onCommands: Map<PowerState, PowerCommand> = mutableMapOf<PowerState, PowerCommand>().apply {
        this[PowerState.ON_STAGE1] = PowerCommand("/5J1R", 1000)
        this[PowerState.ON_STAGE1_REPEAT] = PowerCommand("/5J1R", 1000)
        this[PowerState.ON_STAGE2B] = PowerCommand(
            "/5J1R", 1000, "@5J101 ",
            "@5J001 "
        )
        this[PowerState.ON_STAGE2] = PowerCommand("/5J5R", 1000, "@5J101 ")
        this[PowerState.ON_STAGE3A] = PowerCommand("/5H0000R", 500)
        this[PowerState.ON_STAGE3B] = PowerCommand("/5H0000R", 500)
        this[PowerState.ON_STAGE3] = PowerCommand(CO2_REQUEST, 2000)
        this[PowerState.ON_STAGE4] = PowerCommand("/1ZR", 0)
    }
    private val offCommands: Map<PowerState, PowerCommand> = mutableMapOf<PowerState, PowerCommand>().apply {
        this[PowerState.OFF_STAGE1] = PowerCommand("/5H0000R", 1000)
        this[PowerState.OFF_FINISHING] = PowerCommand("/5J1R", 1000)
        this[PowerState.OFF_WAIT_FOR_COOLING] = PowerCommand("/5H0000R", 1000)
    }
