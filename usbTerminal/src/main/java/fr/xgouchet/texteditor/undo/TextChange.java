...
public interface TextChange {
	 ...
	 * Method is deprecated, you should use the canMergeXXX methods instead
	 *
	 * @param sequence the sequence being appended to this {@link TextChange}
	 */
	@Deprecated
	 ...
	 */
	boolean canMergeChangeBefore(CharSequence s, int start, int count, int after);
	 ...
	 * @return if the change can be merged with this {@link TextChange}
	 */
	boolean canMergeChangeAfter(CharSequence s, int start, int before, int count);
