...
public class Constants {
	...
	public static final String ACTION_WIDGET_OPEN = "fr.xgouchet.texteditor" +
			".ACTION_TED_WIDGET_OPEN";
	...
	/**
	 * render chart from existing file
	 */
	public static final int MENU_ID_OPEN_CHART = 10;
