...
public final class LogUtils {
	 ...
	 */
	public static final int println(final int priority, final String tag, final String msg) {
	...
	/**
	 * @param mode how to insert the link in the log message (one of
	...
	private static void buildLink(final StackTraceElement element, final StringBuilder builder) {
